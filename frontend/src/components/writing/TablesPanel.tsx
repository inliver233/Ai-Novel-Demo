      ...
      {!props.projectId ? (
        ...
        <div className="mt-5 grid gap-4">
          <div className="panel p-4">
            ...
            {tablesError ? <div className="mt-3 text-sm text-amber-700 dark:text-amber-300">{tablesError}</div> : null}
          ...
          {selectedTable ? (
            <div className="panel p-4">
              ...
              {rowsError ? <div className="mt-3 text-sm text-amber-700 dark:text-amber-300">{rowsError}</div> : null}
                    ...
                    <thead>
                      <tr>
                        {selectedColumns.map((c) => (
                          ...
                          >
                            {c.label || c.key}
                            {c.required ? <span className="ml-1 text-amber-700 dark:text-amber-300">*</span> : null}
