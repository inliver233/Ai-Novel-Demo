        ...
        <div className="grid gap-3">
          ...
          <textarea
            ...
            onChange={(e) =>
              props.setPromptForm((v) => ({
                ...v,
                outline_generate: { ...v.outline_generate, user_template: e.target.value },
              }))
            }
          ...
          <div className="surface p-4">
            <div className="text-xs text-subtext">
              预览缺失占位符：{props.outlinePreview.missing.join(", ") || "无"}
            </div>
        ...
        <div className="grid gap-3">
          ...
          <textarea
            ...
            onChange={(e) =>
              props.setPromptForm((v) => ({
                ...v,
                chapter_generate: { ...v.chapter_generate, system_template: e.target.value },
              }))
            }
            placeholder="system_template"
          />
          <textarea
            ...
            onChange={(e) =>
              props.setPromptForm((v) => ({
                ...v,
                chapter_generate: { ...v.chapter_generate, user_template: e.target.value },
              }))
            }
            placeholder="user_template"
          />
          <div className="surface p-4">
            <div className="text-xs text-subtext">
              预览缺失占位符：{props.chapterPreview.missing.join(", ") || "无"}
            </div>
            <div className="mt-3 grid gap-2">
              <div className="text-xs text-subtext">system</div>
